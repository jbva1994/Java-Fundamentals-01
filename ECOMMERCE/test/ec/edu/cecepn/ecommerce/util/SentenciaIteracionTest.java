...
/**
 * Clase que permitirá ejemplificar el uso de las sentencias de iteración
 * 
 * @author jbva1994
 *
 *         28 feb. 2019 - 19:21:49
 */
public class SentenciaIteracionTest {
	...
	/**
	 * Método para testear el while. Itera hasta que se cumpla una condición.
	 * El tema de iteracion es dentro del while
	 */
	...
	/**
	 * Método para testear el do while, es similar al while pero con la diferencia que se ejecuta al menos
	 * una vez cumpla o no la condicion
	 */
